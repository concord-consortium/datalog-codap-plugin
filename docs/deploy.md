...
S3 deployment is handled by GitHub Actions. Pushes are deployed to `models-resources/datalog-codap-plugin/` by the `s3-deploy` job in [`ci.yml`](../.github/workflows/ci.yml).
